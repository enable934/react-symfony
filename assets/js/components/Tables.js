                        ...
                        <form method={'POST'} onSubmit={this.onSubmitForm}>
                            <div className={'row'}>
                                <label style={{color: 'white'}} htmlFor="date">Оберіть дату:
                                    <input onChange={this.dateHandler} type="date" id="date" name="date" required/>
                                </label>
                            </div>
                            <div className={'row'}>
                                <label style={{color: 'white'}} htmlFor="timeFrom">Виберіть час з котрої: </label>
                                <input onChange={this.timeFromHandler} id="timeFrom" type="time" name="timeFrom"
                                       step="2" required/>
                            </div>
                            <div className={'row'}>
                                <label style={{color: 'white'}} htmlFor="timeTo">Виберіть час до котрої: </label>
                                <input onChange={this.timeToHandler} id="timeTo" type="time" name="timeTo" step="2" required/>
                            </div>
                            <div className={'row'}>
                                <label style={{color: 'white'}} htmlFor="email">Ваш email:</label>
                                <input onChange={this.emailHandler} type="email" id="email" name="userEmail" required/>
                            </div>
                            <div className={'row'}>
                                <label style={{color: 'white'}} htmlFor="name">Ім'я (4 до 8 символів):</label>
                                <input onChange={this.userNameHandler} type="text" id="name" name="userName" required/>
                            </div>
                            <div className={'row'}>
                                <label style={{color: 'white'}} htmlFor="phone">Ваш телефон:</label>
                                <input onChange={this.userPhoneHandler} type="tel" id="phone" name="userPhone"
                                       required/>
                                <small style={{color: 'white'}}>Формат: +099-999-9999</small>
                            </div>
                            ...
                            <button className="btn btn-primary" type={'submit'}>Підтвердити</button>
                            {loading ? (
                                            ...
                                            <div>
                                                <div>
                                                    ...
                                                    <button disabled={table.orders.length > 0 ? 'disabled' : ''}
                                                            ...
                                                            className="btn btn-default">забронювати
                                                    </button>
                                                </div>
                                            </div>
                                        </div>
